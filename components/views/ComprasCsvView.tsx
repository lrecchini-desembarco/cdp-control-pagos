...
// Vista de carga MANUAL de compras por CSV (facturas/OC reales), conservada como
// pestaña secundaria del tablero /compras. El tablero principal (Consumo CMV vs
// Ventas) usa datos reales de la base — ver ComprasView.tsx.
export default function ComprasCsvView() {
  ...
  return (
    <div className="space-y-4">
      <p className="max-w-2xl text-sm text-muted">
        Cruce por <b>factura/OC real</b>: subí el CSV de compras de un local y auditá la cobertura contra las
        ventas de Tango del mismo período. Complementa el tablero de consumo (que ya es automático).
      </p>
