...
// Pestaña "Compras" del módulo Inventario: equipos y recursos comprados o en
// proceso de alta (pedido → comprado → llegó → listo), con la aprobación del
// Dueño. Es el CRUD que ya existía; el parque de computadoras va aparte.
export default function RecursosIT({ rol }: { rol: string }) {
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <p className="max-w-2xl text-sm text-muted">
          Equipos y recursos comprados o en proceso de alta. Editá cantidad, estado y aprobación directo en la tabla.
        </p>
