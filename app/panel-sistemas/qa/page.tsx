...
// Espejo de /qa (Operaciones también lo usa y sigue entrando por ahí): NO se
// toca QaView -- cambiarla acá afectaría esa ruta también. Solo se envuelve
// en la card punteada de "espejo" que pide el handoff de la consola.
export default function Page() {
  return (
    <div className="space-y-4">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h1 className="font-display text-[23px] font-semibold tracking-[-.02em] text-[#ece9e2]">QA diario</h1>
